...
For **Elasticsearch 2.0** and later, use the version 2 (``elasticsearch2-dsl``)
or major version 2 (``2.x.y``) of the library.

For **Elasticsearch 1.0** and later, use the version 1 (``elasticsearch1-dsl``)
or major version 0 (``0.x.y``) of the library.
...
The development is happening on ``master``, ``1.x`` and ``2.x`` branches,
respectively.
