...
class IndexTemplate(object):
    ...
    def save(self, using=None):
        es = get_connection(using or self._index._using, is_async=SYNC_IS_ASYNC)
...
class Index(object):
    ...
    def _get_connection(self, using=None):
        ...
        return get_connection(using or self._using, is_async=SYNC_IS_ASYNC)
    ...
    def create(self, using=None, **kwargs):
        ...
        """
        return self._get_connection(using=using).indices.create(
            index=self._name, body=self.to_dict(), **kwargs
        )

    def is_closed(self, using=None):
        state = self._get_connection(using=using).cluster.state(
