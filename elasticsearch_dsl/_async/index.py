...
class AsyncIndexTemplate(object):
    ...
    async def save(self, using=None):
        es = get_connection(using or self._index._using, is_async=ASYNC_IS_ASYNC)
...
class AsyncIndex(object):
    ...
    def _get_connection(self, using=None):
        ...
        return get_connection(using or self._using, is_async=ASYNC_IS_ASYNC)
    ...
    def update_by_query(self, using=None):
        """
    ...
    async def create(self, using=None, **kwargs):
        ...
        """
        return await self._get_connection(using=using).indices.create(
            index=self._name, body=self.to_dict(), **kwargs
        )

    async def is_closed(self, using=None):
        state = await self._get_connection(using=using).cluster.state(
