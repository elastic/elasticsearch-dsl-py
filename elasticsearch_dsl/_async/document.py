...
from elasticsearch_dsl.utils import DOC_META_FIELDS, META_FIELDS, ObjectBase, merge
...
class Document(ObjectBase):
    ...
    async def get(cls, id, using=None, index=None, **kwargs):
        ...
        ensure_async_connection(es, "Document.get")
    ...
    async def mget(
        ...
        results = await es.mget(body, index=cls._default_index(index), **kwargs)
    ...
    async def delete(self, using=None, index=None, **kwargs):
        ...
        ensure_async_connection(es, "Document.delete")
    ...
    async def update(
        ...
        **fields
        ...
        es = self._get_connection(using)
        ensure_async_connection(es, "Document.update")
    ...
    async def save(self, using=None, index=None, validate=True, skip_empty=True, **kwargs):
        ...
        es = self._get_connection(using)
        ensure_async_connection(es, "Document.save")
